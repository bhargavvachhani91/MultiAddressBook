...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-2">
                    <asp:HyperLink runat="server" ID="hlAddState" Text="Add new City" CssClass="btn btn-warning" NavigateUrl="~/MultiUserAddressBook/Admin Panel/City/CityAddEdit.aspx"></asp:HyperLink>
                </div>
                <div class="col-md-10">
                </div>
            </div>
                ...
                <asp:GridView ID="gvCity" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" OnRowCommand="gvCity_RowCommand" Width="1121px">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="hlEdit" Text="Edit" CssClass="btn btn-info btn btn-sm" NavigateUrl='<%#"~/MultiUserAddressBook/Admin Panel/City/CityAddEdit.aspx?CityID="+Eval("CityID").ToString().Trim() %>'>
